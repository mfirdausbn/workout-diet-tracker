            ...
            <div className="w-2/3 m-8">
              <Card>
                ...
                <div className="flex justify-evenly">
                  ...
                  <div>
                    <ul>Your start weight: {userInfo.startWeight} kg</ul>
                    <ul>Your start Body Fat: {userInfo.startBodyFat} %</ul>
                    <ul>
                      Your start Muscle Mass: {userInfo.startMuscleMass} %
                    </ul>
                  </div>
              ...
              <div className="flex flex-col items-center justify-center mt-8 ">
                ...
                >
                  Update your update weight, body fat and muscle mass here
                </Button>
            ...
            <div className="w-2/3">
              <Card>
                ...
                <div className="flex justify-evenly">
                  ...
                  <div>
                    <ul>Your end weight: {userInfo.endWeight} kg</ul>
                    <ul>Your end Body Fat: {userInfo.endBodyFat} %</ul>
                    <ul>Your end Muscle Mass: {userInfo.endMuscleMass} %</ul>
                  </div>
